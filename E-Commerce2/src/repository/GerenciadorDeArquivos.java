...
public class GerenciadorDeArquivos {
    ...
    private final Path produtosFile = Paths.get("src/produtos2.txt");
    private final Path pedidosFile = Paths.get("src/pedidos2.txt");

    private final AtomicLong produtoIdGen = new AtomicLong(loadLastId(produtosFile));
    private final AtomicLong pedidoIdGen = new AtomicLong(loadLastId(pedidosFile));

    // ===========================
    // MÉTODO: CARREGAR PEDIDOS
    // ===========================
