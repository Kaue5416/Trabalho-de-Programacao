...
import factoryMethod.Pagamento;
...
public class MenuCliente {
    ...
    private void finalizarCompra() {
        ...
        Pagamento pagamento = PagamentoFactory.criarPagamento(nomePagamento);
        ...
        for (ItemPedido it : carrinho.getItens()) {
            ...
            Optional<Produto> op = arquivo.buscarProdutoPorId(it.getProduto().getId()); 
